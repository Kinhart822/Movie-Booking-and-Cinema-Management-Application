...
import vn.edu.usth.mcma.frontend.components.Login.Register_Activity;
import vn.edu.usth.mcma.frontend.components.Showtimes.Adapters.PaymentMethodAdapter;
import vn.edu.usth.mcma.frontend.components.Showtimes.Models.Booking.PaymentMethod;
...
public class PayingMethodActivity extends AppCompatActivity {
    ...
    private vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod selectedPaymentMethod;
...
//    }
    ...
    private void setupPaymentMethodsRecyclerView() {
        List<vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod> paymentMethods = new ArrayList<>();
        paymentMethods.add(new vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod("Cổng VNPAY", R.drawable.ic_vnpay));
        paymentMethods.add(new vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod("Ví Momo", R.drawable.ic_momo));
        paymentMethods.add(new vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod("Ví Zalopay", R.drawable.ic_zalopay));
        paymentMethods.add(new vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod("Thẻ ATM nội địa (Internet Banking)", R.drawable.ic_atm));
        paymentMethods.add(new vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod("Thẻ quốc tế (Visa, Master, Amex, JCB)", R.drawable.ic_credit_card));
        paymentMethods.add(new vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod("Ví ShopeePay", R.drawable.ic_shopeepay));

        Set<String> uniqueNames = new LinkedHashSet<>();
        List<vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod> uniquePaymentMethods = new ArrayList<>();
        for (vn.edu.usth.mcma.frontend.components.Showtimes.Models.PaymentMethod method : paymentMethods) {
