...
//        adapter = new RatingMovie_Adapter(requireContext(), items, (movieName, movieType, movieImage) -> showFeedbackDialog(movieName, movieType, movieImage));

//        adapter = new RatingMovie_Adapter(requireContext(), items, this::showFeedbackDialog);
...
//    private void showFeedbackDialog(String movieName, String movieType, String movieImage) {
