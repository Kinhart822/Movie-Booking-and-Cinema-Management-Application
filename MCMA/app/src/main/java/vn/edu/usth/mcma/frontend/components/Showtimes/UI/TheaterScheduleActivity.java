...
import vn.edu.usth.mcma.frontend.network.apis.GetAllInformationOfSelectedMovie;
import vn.edu.usth.mcma.frontend.network.apis.GetAllMovieAPI;
import vn.edu.usth.mcma.frontend.network.apis.GetScheduleAPI;
import vn.edu.usth.mcma.frontend.network.RetrofitService;
import vn.edu.usth.mcma.frontend.components.Showtimes.Models.Movie;
import vn.edu.usth.mcma.frontend.components.Showtimes.Adapters.MovieScheduleAdapter;
...
public class TheaterScheduleActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theaterId = getIntent().getIntExtra(IntentKey.CINEMA_ID.name(), -1);
