...
//            switch (fragmentName) {
//                case "home":
//                    activity.close_to_home_page();
//                    break;
//                case "showtimes":
//                    activity.close_to_showtimes_page();
//                    break;
//                case "store":
//                    activity.close_to_store_page();
//                    break;
//                case "feedback":
//                    activity.close_to_feedback_page();
//                    break;
//                case "personal":
//                    activity.close_to_personal_page();
//                    break;
//            }
...
public class LaunchtimeFragment extends Fragment implements TheaterAdapter.OnTheaterClickListener {
    ...
    private void setupCityButtons(View v) {
        LinearLayout cityContainer = v.findViewById(R.id.city_container);
        if (cityContainer != null) {
            cityContainer.removeAllViews();
            List<String> cities = TheaterDataProvider.getCities();
