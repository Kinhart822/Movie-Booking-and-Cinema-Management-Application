...
public class SeatSelectionActivity extends AppCompatActivity {
    ...
    public void onSeatClickListener() {
        totalSeatCountTextView.setText(String.format("%d / %d seats selected", seatAdapter.getCurrentAudienceCount(), booking.getTotalAudienceCount()));
        totalPriceTextView.setText("$" + (previousTotalPrice + seatAdapter.getTotalSeatPrice(seatTypes)));
        nextButton.setEnabled(seatAdapter.getCurrentAudienceCount() == booking.getTotalAudienceCount());
    }
