...
public class SearchMovieByNameResponse {
    ...
    public SearchMovieByNameResponse(String backgroundImageUrl, String datePublish, String description, List<String> genreNameList, Integer id, String imageUrl, Integer length, String name, List<String> performerNameList, List<String> performerSex, List<String> performerType, List<String> ratingDescriptionList, List<String> ratingNameList, String trailerLink) {
